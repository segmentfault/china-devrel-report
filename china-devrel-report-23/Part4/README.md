![image](https://github.com/Nico-Tech-Shenzhen/china-devrel-report-jp/assets/1667148/392025ec-b640-42d2-963a-563c348d7550)# Ⅳ. 中国におけるデベロッパー・リレーションズ実務家の現状報告
## 1 はじめに
## 1.1 調査の背景と目的
...
今年の調査結果では、企業のエコロジー構築や開発者との関係に密接に関連するテクノロジー産業に加えて、マーケティング・広告（**8.8％***）と教育・研究（**0.7％***）という2つの産業も注目された。 大企業のオープンソースや開発者エコシステムへの投資が増加する中、大企業と長年協力してきた広告代理店やPR代理店もこの分野に注目し始め、関連プロジェクトチームを立ち上げている。例えば、Qunyi、Xuanbird、Mingsili、Shangcheng Tongli、DIS Media、Wise Branding、Wisdom Transmissionなどが挙げられる。 デベロッパーとの関係に教育と研究の焦点を当てることで、産・学・研の力を統合し、業界の発展を共同で促進することができるだろう。
...
! [回答者の企業の⽂化的特徴の分布](...) /attachments/respondent_company_culture_characteristics.jpg)
...
! [用途：オペレーションが最も認知されている](...) /attachments/respondents_job_roles_vs_preferred_performance_metrics_comparison_3.jpg)
...
! [業界の視点：デベロッパー・リレーション部門の独立設置は必要か】（... /attachments/is_a_dedicated_developer_relations_department_necessary.jpg)
...
|-----------------|----------|----------|----------|----------|----------|
| デベロッパー・リレーション・チーム｜-7.507｜0.433｜5.970｜3.145｜である。
